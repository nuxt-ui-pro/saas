...
::div{ .grid .grid-cols-3 .items-center .w-full .gap-x-8 }
  ![Royal Eagle](https://source.unsplash.com/random/400x400/?rocket){ .rounded-lg .col-span-1 }
  ::div{ .col-span-2 }
...
::div{ .grid .grid-cols-3 .items-center .w-full .gap-x-8 }
  ...
  ::
  ![Royal Eagle](https://source.unsplash.com/random/400x400/?universe){ .rounded-lg .col-span-1 }
::

## Legacy of Discovery

::div{ .grid .grid-cols-3 .items-center .w-full .gap-x-8 }
  ![Royal Eagle](https://source.unsplash.com/random/400x400/?childrens){ .rounded-lg .col-span-1 }
  ::div{ .col-span-2 }
