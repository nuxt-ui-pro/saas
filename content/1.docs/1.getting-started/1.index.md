...
:u-button{icon="i-simple-icons-stackblitz" to="https://stackblitz.com/github/nuxt-ui-pro/sass/" label="Play on StackBlitz" target="_blank" class="mr-4"}

:u-button{icon="i-simple-icons-codesandbox" to="https://codesandbox.io/s/github/nuxt-ui-pro/sass/" label="Play on CodeSandbox" target="_blank" class="mt-2 sm:mt-0"}
