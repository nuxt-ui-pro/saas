...
This template is a ready-to-use SaaS template made with [Nuxt UI](https://ui.nuxt.com), a collection of components built on top of Tailwind CSS to create beautiful & responsive Nuxt applications in minutes.
